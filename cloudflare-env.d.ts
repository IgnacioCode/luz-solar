/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: d44a5eb3680f286fdcebc51d84d2ecb2)
// Runtime types generated with workerd@1.20260714.1 2026-07-21 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	NEXT_PUBLIC_PRODUCTS_CSV_URL: string;
	PRODUCTS_CSV_URL: string;
	NEXT_PUBLIC_PRODUCTS_CSV_REVALIDATE_SECONDS: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_PRODUCTS_CSV_URL" | "PRODUCTS_CSV_URL" | "NEXT_PUBLIC_PRODUCTS_CSV_REVALIDATE_SECONDS">> {}
}
