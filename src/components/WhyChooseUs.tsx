...
export default function WhyChooseUs() {
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 w-80 h-80 bg-[#19A7CE]/5 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute top-1/2 right-0 w-80 h-80 bg-[#57C5B6]/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {commercialArgumentsData.map((arg) => {
            ...
            return (
              <div
                ...
                className="p-6 sm:p-8 rounded-2xl bg-slate-50 border border-slate-200 hover:border-[#19A7CE]/30 hover:bg-white transition-all duration-300 hover:shadow-md hover:-translate-y-1"
              >
                <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-5">
                  {/* Icon Wrapper */}
                  <div className="p-3.5 rounded-xl bg-white border border-slate-150 text-[#19A7CE] shrink-0">
        ...
        <div className="mt-16 text-center">
          <p className="text-xs font-mono text-slate-500 uppercase tracking-widest">
            ...
            <span className="text-[#57C5B6] font-bold">Iram / AEA 90364-7-712</span>
          </p>
        </div>
