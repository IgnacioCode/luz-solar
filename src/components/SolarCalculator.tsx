...
export default function SolarCalculator({ onPreFillInquiry }: SolarCalculatorProps) {
  ...
  const handleConsultWhatsApp = () => {
    const text = `Hola Helios Solar! Utilicé su Calculadora de Ahorro Web y obtuve estos resultados estimativos para mi *${clientType.toUpperCase()}*:\n\n` +
  ...
  return (
    <section id="calculadora" className="py-24 bg-white relative overflow-hidden border-t border-b border-slate-100">
      {/* Background accents */}
      <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-[#19A7CE]/5 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2 w-[400px] h-[400px] bg-[#57C5B6]/5 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-6 bg-slate-50 border border-slate-200 rounded-3xl p-6 sm:p-8 flex flex-col justify-between space-y-8 shadow-sm">
            <div className="space-y-6">
              <h3 className="text-lg font-bold text-[#0B2447] flex items-center gap-2">
                  ...
                  {(['hogar', 'comercio', 'industria', 'campo'] as ClientType[]).map((type) => (
                    <button
                      ...
                      className={`py-3 px-4 rounded-xl text-xs font-bold capitalize border transition-all cursor-pointer text-center ${
                        clientType === type
                          ? 'bg-[#19A7CE] text-white border-[#19A7CE] shadow-md shadow-sky-500/10'
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between text-xs font-mono font-bold uppercase tracking-wider text-slate-500">
                  ...
                  <span className="text-[#19A7CE] text-sm font-sans font-extrabold">
                ...
                <input
                  ...
                  className="w-full h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-[#19A7CE] focus:outline-none"
                />
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`py-2.5 rounded-lg text-xs font-bold border transition-all cursor-pointer ${
                        roofType === roof.val
                          ? 'bg-white border-[#19A7CE] text-[#19A7CE] shadow-sm'
            ...
            <div className="p-4 rounded-xl bg-slate-100 border border-slate-200 flex items-start gap-2.5 text-[11px] text-slate-500">
              <span className="w-1.5 h-1.5 rounded-full bg-[#F27D26] shrink-0 mt-1.5" />
          ...
          <div className="lg:col-span-6 bg-gradient-to-br from-[#0B2447] to-[#123769] border border-slate-800 rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-xl relative overflow-hidden">
            ...
            <div className="space-y-6">
              <h3 className="text-sm font-mono font-bold tracking-wider text-slate-300 uppercase flex items-center gap-2">
                <Sparkles className="w-4 h-4 text-[#57C5B6] animate-pulse" />
                <span>Estimación del Sistema Helios</span>
              </h3>

              {/* Big Sizing Indicators */}
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/5 p-4 rounded-2xl border border-white/10">
                  <div className="flex items-center space-x-1.5 text-[#19A7CE] mb-1">
                    <Zap className="w-4.5 h-4.5 text-[#19A7CE]" />
                ...
                <div className="bg-white/5 p-4 rounded-2xl border border-white/10">
                  <div className="flex items-center space-x-1.5 text-[#57C5B6] mb-1">
                    <Calculator className="w-4.5 h-4.5 text-[#57C5B6]" />
              ...
              <div className="p-5 rounded-2xl bg-[#57C5B6]/10 border border-[#57C5B6]/25 space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-slate-200">Ahorro Mensual Estimado:</span>
                  <span className="text-sm font-extrabold text-[#57C5B6] font-mono">+${results.monthlySavings.toLocaleString('es-AR')}</span>
                </div>
                <div className="flex items-center justify-between pt-3.5 border-t border-[#57C5B6]/20">
                  <span className="text-xs font-bold text-slate-200">Ahorro Anual Estimado:</span>
                  <span className="text-lg font-extrabold text-[#57C5B6] font-mono">+${results.yearlySavings.toLocaleString('es-AR')}</span>
                </div>
                <div className="flex items-center justify-between text-[11px] text-slate-300">
                  <span>Plazo de Amortización Estimado:</span>
                  <span className="font-mono text-[#19A7CE] font-bold">{results.amortizationYears} Años aprox.</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3.5 p-4 rounded-2xl bg-white/5 border border-white/10">
                <div className="flex items-center space-x-2.5">
                  <Leaf className="w-5 h-5 text-[#57C5B6] shrink-0" />
                  <div>
                ...
                <div className="flex items-center space-x-2.5 border-l border-white/10 pl-3.5">
                  <div className="text-[#57C5B6] text-sm font-bold shrink-0 font-mono">🌳</div>
                  <div>
            ...
            <div className="pt-6 mt-6 border-t border-white/10 flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="w-full sm:w-1/2 flex items-center justify-center space-x-1.5 py-3 rounded-full bg-[#F27D26] text-white hover:bg-orange-600 text-xs font-bold shadow-lg shadow-orange-500/10 hover:shadow-orange-500/25 hover:-translate-y-0.5 active:translate-y-0 transition-all cursor-pointer"
              >
